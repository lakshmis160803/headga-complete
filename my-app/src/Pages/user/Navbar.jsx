    ...
    <div className="sticky top-0 z-50 bg-white shadow">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <button onClick={() => navigate("/")} className="hover:text-blue-600 text-lg">
            Home
          </button>

          <button onClick={() => navigate("/productdetails")} className="hover:text-blue-600 text-lg">
            Products
          </button>
          ...
          <button onClick={() => navigate("/orders")} className="hover:text-blue-600 text-lg">
            Orders
          </button>
        </div>
      ...
      {openMenu && (
        <div className="md:hidden bg-white border-t px-6 py-4 space-y-4 shadow">
          ...
          <button
            onClick={() => { navigate("/productdetails"); setOpenMenu(false); }}
            className="block w-full text-left"
          >
            Products
          </button>
          ...
          <button
            onClick={() => { navigate("/wishlist"); setOpenMenu(false); }}
            className="block w-full text-left"
          >
          ...
          <button
            onClick={() => { navigate("/order"); setOpenMenu(false); }}
            className="block w-full text-left"
          >
            Orders
          </button>
